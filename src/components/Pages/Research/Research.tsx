...
bl_category_tags:item.bl_category_tags,
  ...
  const filtered = blogs.filter((b) =>
    `${b.title} ${b.bl_category_tags} ${b.highlights}`
      .toLowerCase()
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">Research Post</h1>
      ...
      <Modal
        ...
        title={editing ? "Edit Blog" : "Add Research"}
      >
        <div className="space-y-4">
          ...
          <input
            type="text"
            placeholder="Highlights  (Seperation with comma)"
